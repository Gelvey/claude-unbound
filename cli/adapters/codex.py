...
class CodexCliAdapter:
    ...
    def build_task_invocation(
        ...
        *,
        ...
        cmd = self._task_command(
            ...
            dangerously_bypass_approvals=getattr(
                config, "dangerously_bypass_approvals", True
            ),
        )
        resume_session_id = (
            request.session_id
    ...
    def _task_command(
        ...
        *,
        ...
        workspace_path: str,
        dangerously_bypass_approvals: bool = True,
    ) -> list[str]:
        bypass_args = (
    ...
    def _codex_config_args(
        ...
        args = [
            ...
            "-c",
            _toml_assignment("model_providers.fcc.name", "Claude Unbound"),
            "-c",
