...
FREEBUFF_DEFAULT_BASE = "http://127.0.0.1:8080/v1"
...
PROVIDER_CATALOG: dict[str, ProviderDescriptor] = {
    ...
    "freebuff": ProviderDescriptor(
        provider_id="freebuff",
        transport_type="openai_chat",
        static_credential="freebuff",
        default_base_url=FREEBUFF_DEFAULT_BASE,
        base_url_attr="freebuff_base_url",
        capabilities=(
            "chat",
            "streaming",
            "tools",
