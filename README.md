...
<div align="center">
  <img src="assets/pic.png" alt="Claude Unbound in action" width="700">
  <p><em>Claude Code running through the Claude Unbound proxy.</em></p>
</div>

<div align="center">
  <img src="assets/codex.png" alt="Codex CLI in action through Claude Unbound" width="700">
  <p><em>Codex CLI using the local Claude Unbound Responses provider.</em></p>
</div>
...
<div align="center">
  ...
  <p><em>Claude Code native <code>/model</code> picker with Claude Unbound gateway models.</em></p>
</div>

<div align="center">
  <img src="assets/codex-model-picker.png" alt="Codex model picker showing generated Claude Unbound model catalog" width="700">
  <p><em>Codex native <code>/model</code> picker with the generated Claude Unbound catalog.</em></p>
</div>

## Fork Notes

This is a personal fork of [Gelvey/claude-unbound](https://github.com/Gelvey/claude-unbound) maintained as a patchset on top of upstream. We pull from upstream but do not push our changes back. For the unmodified upstream project, visit the [original repo](https://github.com/Gelvey/claude-unbound).
...
The MCP meta-router (`scripts/mcp/`) exposes multiple MCP servers through a single Unix socket. Claude Code connects to the router, which manages backend activation on demand (Stripe, Supabase, Resend, etc.) so each backend's tools are available without running all of them simultaneously.
...
<div align="center">
  <a href="https://star-history.com/#Gelvey/claude-unbound&Date">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Gelvey/claude-unbound&type=Date&theme=dark">
      <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Gelvey/claude-unbound&type=Date">
      <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Gelvey/claude-unbound&type=Date" width="700">
    </picture>
  </a>
</div>
...
The OpenAI-compat layer advertises no `/models` endpoint, so Claude Unbound ships a curated list of free Workers AI chat models that work well for coding/agent workloads:
...
codex \
  ...
  -c 'model_providers.fcc.name="Claude Unbound"' \
...
# Both backends
curl -fsSL "https://github.com/Gelvey/claude-unbound/blob/main/scripts/install.sh?raw=1" | sh -s -- --voice-all
...
<div align="center">
  <img src="assets/how-it-works.svg" alt="Claude Unbound request flow architecture" width="900">
</div>
...
```bash
git clone https://github.com/Gelvey/claude-unbound.git
cd claude-unbound
