...
cd claude-unbound
git remote add upstream https://github.com/Gelvey/claude-unbound.git
git fetch upstream
```
...
gh api repos/Gelvey/claude-unbound/branches/main/protection -X DELETE
...
# want them enabled).
gh api repos/Gelvey/claude-unbound/branches/main/protection -X PUT --input - <<'JSON'
{
...
- **Public URLs only** — example SSH/SCP/URL strings should reference the public fork URL (`https://github.com/Gelvey/claude-unbound.git`) or upstream (`https://github.com/Gelvey/claude-unbound.git`), not private workspaces.
