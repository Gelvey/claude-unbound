...
class MessagesRequest(BaseModel):
    ...
    # Client ``anthropic-beta`` header captured at ingress. Private attrs are
    # excluded from ``model_dump`` and survive ``model_copy(deep=True)``; native
    # Anthropic transports forward this upstream when FORWARD_ANTHROPIC_BETA.
    _anthropic_beta: str | None = PrivateAttr(default=None)
